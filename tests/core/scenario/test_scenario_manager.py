...
def test_get_primary_scenarios_sorted():
    ...
    not_primary_scenario = _ScenarioManager._create(scenario_1_cfg, creation_date=datetime(2024, 1, 1, 0, 0, 0), name="not_primary_scenario")
...
def test_tags():
    cycle_1 = _CycleManager._create(Frequency.DAILY, name="today", creation_date=datetime(2024, 1, 1, 0, 0, 0))
    cycle_2 = _CycleManager._create(
        Frequency.DAILY,
        name="tomorrow",
        creation_date=datetime(2024, 1, 1, 0, 0, 0) + timedelta(days=1),
    )
